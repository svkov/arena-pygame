...
def player(sprites, fps):
    return {
        PlayerStates.IDLE: Animation(sprites['knight_idle'], duration=0.4, fps=fps, image_size=(512, 512)),
        PlayerStates.ATTACK: Animation(sprites['knight_attack'], duration=0.2, fps=fps, image_size=(512, 512),
                                       times_to_play=1),
        PlayerStates.BACK: Animation(sprites['knight_back'], duration=0.4, fps=fps, image_size=(512, 512),
                                     times_to_play=1),
    }
